...
student1 = Student("Дем'ян")
student2 = Student("Денис")
...
```
## Висновок:
У ході виконання лабораторної роботи я ознайомився з різними типами змінних в об’єктно-орієнтованому програмуванні, зокрема з атрибутами об’єкта та змінними класу. Я навчився створювати класи з конструкторами, які приймають декілька аргументів, та формувати на їх основі атрибути. Також я реалізував методи для опису об’єктів, створював декілька екземплярів класу та викликав методи як через об’єкт, так і через клас. Окрім цього, я познайомився з поняттям змінної класу, навчився змінювати її значення та використовувати у методах. Додатково я реалізував лічильник створених об’єктів за допомогою змінної класу та методу класу. Отримані знання допоможуть мені краще розуміти принципи ООП та ефективніше використовувати їх у програмуванні на Python.
